...
export default {
  ...
  methods: {
    init() {
      ...
      console.log(this.$refs.plane.documentElement)
      document.addEventListener('pointermove', ({ x, y }) => {
        const newX = gsap.utils.mapRange(0, innerWidth, -BOUNDS, BOUNDS, x);
        const newY = gsap.utils.mapRange(0, innerHeight, BOUNDS, -BOUNDS, y);
