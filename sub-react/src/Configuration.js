...
import { prism as Light, atomDark as Dark } from './prism'
...
const Configuration = ({ previewBox, activeLightSource = 1 }) => {
  ...
  }, [color, colorDifference, gradient, shape, activeLightSource, blur, size, radius, maxRadius, distance, previewBox])
  return (
